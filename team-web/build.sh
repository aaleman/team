...
vulcanize \
    ...
    --js build/tmp/team.js

uglifyjs build/tmp/team.js > build/tmp/team.min.js

sed -i s@team.js@team.min.js@g build/tmp/index.html
...
mv build/tmp/team.js build/
mv build/tmp/team.min.js build/
cp -r conf build/
